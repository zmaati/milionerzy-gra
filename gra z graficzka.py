...
def Telefonik():
    # TO DO POPRAWKI OK OK OK OK - KRYSTIAN OK OK // ZROBIONE   
...
Telefon = tk.Button(root, text="Telefon do przyjaciela", command=lambda:Telefonik(),bg="dark blue",font=czcionka, width=20,fg="#F8C653")
